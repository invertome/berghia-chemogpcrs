...
#
# It STOPS at the report — selection + caching into proteomes_braker4/ is a
# separate, user-gated step (the chosen proteome feeds the all-557 orthology run).
#
...
log "===== ${REPORT} ====="
cat "${REPORT}"
log "DONE — review the table, then cache the chosen proteome into proteomes_braker4/ (user-gated)."
